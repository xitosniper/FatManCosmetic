...
public class MainActivity extends AppCompatActivity {
    ...
    public void addDB() {
        ...
        byte[] avatarInByte = baos.toByteArray();

        customerModel.addCustomer(new CustomerInfo("000001", "", "123456", "", "", "", "", "Phạm Trương Anh Tú", avatarInByte, "28", 1, "0903831374", "2Q1 Bình Giã P.13", "khuongnt@gmail.com", 1));

        commentModel.addComment(new CommentInfo("000001", "000001", "000002", "2020/11/10", "Sản phẩm rất tốt", 1));
        commentModel.addComment(new CommentInfo("000002", "000001", "000002", "2020/11/10", "Sản phẩm nên dùng nhé mọi người", 1));
